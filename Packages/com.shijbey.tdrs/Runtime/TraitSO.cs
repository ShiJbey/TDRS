...
namespace TDRS
{
	...
	public class TraitSO : ScriptableObject
	{
		...
		[SerializeField]
		private TraitSO[] m_conflictingTraits;
		...
		public TraitDefinition GetTraitDefinition()
		{
			...
			HashSet<string> conflictingTraitIDs = new HashSet<string>();

			for (int i = 0; i < m_conflictingTraits.Length; i++)
			{
				conflictingTraitIDs.Add(m_conflictingTraits[i].m_traitID);
			}
